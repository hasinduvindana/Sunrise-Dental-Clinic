    ...
    return send
      ...
      .catch(function (e) {
        ...
        if (typeof showToast === 'function') {
          showToast(e.message || 'The clinic server rejected that change', 'error');
        } else {
          alert(e.message || 'The clinic server rejected that change');
        }
        return ClinicStore.refresh().then(function () { ClinicStore._notify(); });
      });
  }
